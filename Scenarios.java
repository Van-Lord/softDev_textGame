...
public class Scenarios {
	...
	public static final String INTRO = "A group of travelers make way to the newly found planet of unknown name. "
	...
	public static final String ROOM2 = "Walking west of the spacecraft, the YOU admire the beauty of the planet. "
	...
	public static final String ROOM3 = "Walking to the left, you walk through the curved shaped entrance into the pitch black cave. "
	...
	public static final String ROOM4 = "Another door opens up and reveals the other side of the mountain. "
	...
	public static final String ROOM5 = "The player takes the right entrance with plasma. "
	...
	public static final String ROOM6 = "After entering the room, you decide, "
			+ "nothing is in the room and get a weird feeling about leaving. ";

	// a.Go further into the room
	// b.Leave the room immediately

	public static final String ROOM6_2 = "You listen to your gut and start back for the entrance. "
			+ "The entrance begins to get farther and farther away. "
			+ "The room closes in on you and you sufocate. {Game over}  ";

	public static final String ROOM7 = "The player decides to stay walking further into the room and comes face to face with the light. "
